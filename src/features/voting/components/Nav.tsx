...
interface NavProps {
    ...
    setActiveSection: (section: number) => void; // Added based on usage in Vote.js
}

const Nav: React.FC<NavProps> = ({ handleNextButton, handlePreviousButton, activeSection, nbDemos, buttonIsDisabled = false }) => {
            ...
            <div className={containerClass}>
                {activeSection > 0 && (
                    <button
                        ...
                        className="rounded border flex items-center gap-2 py-2 px-6 text-gray-700 hover:bg-gray-50"
                        id="prev"
