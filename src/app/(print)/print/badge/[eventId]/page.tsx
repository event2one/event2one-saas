    ...
    return (
        <>
            ...
            <div style={{
                ...
                <div style={{ ...zone, borderRight: '1px dashed #bbb', transform: 'rotate(180deg)', display: 'flex', flexDirection: 'column', padding: '4mm', gap: 0 }}>
                    <div style={{ fontWeight: 900, fontSize: '7pt', color: accent, textTransform: 'uppercase', marginBottom: '1mm' }}>Votre badge d&apos;accès rapide</div>
                    <div style={{ fontSize: '6.5pt', color: '#333', lineHeight: 1.4 }}>
                        <div>1/ Imprimez votre badge et munissez-vous en pour accéder à l&apos;événement.</div>
                        <div>2/ <strong>Pliez-le en 4</strong> et insérez-le dans le porte-badge.</div>
                        <div>3/ Conservez-le précieusement : il vous sera demandé à chaque entrée.</div>
                        <div style={{ fontWeight: 700 }}>4/ Nous recyclons vos badges !</div>
                        <div style={{ color: '#888', fontSize: '6pt' }}>Le port du badge est obligatoire. Bonne visite !</div>
                    </div>
                    {partnersImageUrl && (
                        /* eslint-disable-next-line @next/next/no-img-element */
                        <img src={partnersImageUrl} alt="" style={{ width: '100%', display: 'block', marginTop: '1mm' }} />
                    )}
                    <div style={{ fontSize: '5.5pt', color: '#bbb', marginTop: '1mm' }}>
