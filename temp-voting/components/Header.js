const Header = ({ juryEvent, langId, contactDatas }) => {
    ...
    switch (juryEvent.id_event) {
        ...
        default: logo = '//www.mlg-consulting.com/manager_cc/docs/archives/221018075823_logo-vecto-2021-01-2.png';
            break;
    ...
    return (
        <div>
            ...
            <div className="bg-white flex justify-between container mb-2 space-x-3 items-center"
            >
                ...
                <div><b className="p-1 text-right" style={{ display: "block", fontWeight: "800", fontSize: '9px', textTransform: 'uppercase' }}>{nom}

                    <br /> <span className="text-muted">{juryEvent.nom_us}</span></b>
                </div>
